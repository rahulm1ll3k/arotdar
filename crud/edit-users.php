				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							<label>lc_number <span class="text-danger">*</span></label>
							<input type="text" name="username" id="username" class="form-control" value="<?php echo $row[0]['lc_number']; ?>" placeholder="Enter user name" required>
						</div>
						<div class="form-group">
							<label>lc_date <span class="text-danger">*</span></label>
							<input type="email" name="useremail" id="useremail" class="form-control" value="<?php echo $row[0]['lc_date']; ?>" placeholder="Enter user email" required>
						</div>
						<div class="form-group">
							<label>importer_name <span class="text-danger">*</span></label>
							<input type="tel" name="userphone" id="userphone" maxlength="12" class="form-control" value="<?php echo $row[0]['importer_name']; ?>" placeholder="Enter importer_name" required>
						</div>
						<div class="form-group">
